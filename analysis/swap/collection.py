...
# ----------------------------------------------------------------------------
    ...
    def __init__(self):
        ...
        self.member = {}
        self.probabilities = {'sim':[], 'dud':[],'test':[]}
        self.exposure = {'sim':[], 'dud':[],'test':[]}
...
# Prepare to plot subjects' trajectories:
    ...
    def start_trajectory_plot(self,final=False,title=None,histogram=True,logscale=True):
        ...
        if histogram:
            ...
            plt.axvline(x=x['rejection'],color='red',linestyle='dotted')
            # GENERISIZE THIS
            lower.set_xlabel('Posterior Probability Pr(FEAT|d)')
            lower.set_ylabel('No. of subjects')

        else:
            lower = False
            # GENERISIZE THIS
            upper.set_xlabel('Posterior Probability Pr(FEAT|d)')

...
# ----------------------------------------------------------------------
    ...
    def record_training(self, model_described_by=None, with_params=None, 
        ...
        self.traininghistory['Model'].append(model_described_by)
        self.traininghistory['Parameters'].append(with_params)
        self.traininghistory['TrainingSize'].append(trained_on)
        self.traininghistory['ClassRatio'].append(with_ratio)
        self.traininghistory['At_Time'].append(at_time)
        self.traininghistory['CVScore'].append(with_train_score)
        self.traininghistory['ValidScore'].append(and_valid_score)
    ...
    def is_trained(self, metric):
        ...
        if len(self.traininghistory['CVScore']) >= 4:
        #if len(self.traininghistory['ValidScore']) >= 4:

            differences = np.diff(self.traininghistory['CVScore'])
    ...
    def is_trained_for_testing(self, metric):
        return True
    ...
    def plot_ROC(self):
        # 9/19/16   This is totally broken... 
